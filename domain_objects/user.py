...
from menu.menu import API_SERVER_ADDRESS
...
class Username:
    ...
    def __post_init__(self):
        ...
        # The pattern will ensure that the username is between 3 and 20 chars long and does not contain underscores and dot nor consequently nor at both ends
